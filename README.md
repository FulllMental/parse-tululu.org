...
Для запуска достаточно ввести:
```
python render_website.py --json_folder
```
...
После запуска, сервер будет запущен, открыть библиотеку можно будет по адресу [http://127.0.0.1:5500/](http://127.0.0.1:5500/
)
